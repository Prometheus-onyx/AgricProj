        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#550000] text-white">
                  <Icon className="text-xl" />
                </div>
                <h3 className="mt-5 text-lg font-semibold text-[#550000]">{feature.title}</h3>

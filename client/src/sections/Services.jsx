        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#E8F5E9] text-[#550000]">
                  <Icon className="text-2xl" />
                </div>
                <h3 className="mt-6 text-xl font-semibold text-[#550000]">{service.title}</h3>
